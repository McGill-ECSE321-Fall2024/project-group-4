...
public class Category
{
  ...
  public boolean addGame(Game aGame)
  {
    ...
    games.add(aGame);
    if (aGame.indexOfCatalog(this) != -1)
    {
      wasAdded = true;
    }
    else
    {
      wasAdded = aGame.addCatalog(this);
      if (!wasAdded)
      {
        games.remove(aGame);
      }
  ...
  public boolean removeGame(Game aGame)
  {
    ...
    {
      wasRemoved = aGame.removeCatalog(this);
      if (!wasRemoved)
      {
  ...
  public void delete()
  {
    ...
    {
      if (aGame.numberOfCatalog() <= Game.minimumNumberOfCatalog())
      {
        aGame.delete();
      }
      else
      {
        aGame.removeCatalog(this);
      }
    }
  }
